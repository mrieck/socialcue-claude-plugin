...
function brandFields(b) {
  ...
  return {
    ...
    // Listing facts (directory forms): only what the user recorded — blank = unknown, never guess.
    pricingUrl: b.pricingUrl ?? '', pricingSummary: b.pricingSummary ?? '', repoUrl: b.repoUrl ?? '',
    launchedOn: b.launchedOn ?? '', founders: b.founders ?? '',
