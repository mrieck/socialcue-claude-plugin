...
const FILTERS_BY_VIEW: Record<View, Filters> = {
  ...
  // Directories renders its own panel; preset is unused but keeps navigate() uniform.
  directories: { status: '', notStatus: '', platform: '', brand: '', source: '', kind: '' },
...
export default function App() {
  ...
  const TITLES: Record<View, string> = {
    ...
    directories: 'Directories — get your brand listed everywhere',
              ...
              <div className="queue-wrap">
                {loading
                  ...
                  : <QueueTable
                      ...
                      onSetStatus={view === 'opportunities' ? setStatus : undefined}
                    />}
              </div>
              <DetailPane
