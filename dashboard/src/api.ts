 ...
 */
import type { AssetOnFile, Brand, BrandDetail, CanonicalStatus, ContentItem, ContentStatus, Counts, Destination, DestinationKind, DirectorySettings, Filters, Goal, GoalEntry, GoalPatch, GoalsBoard, LicenseInfo, Opportunity, PerformanceRow, PostIntentResult, PostizChannel, PostizStatus, PostStatus, ProductPost, Settings } from './types';
