...
import { handleDirectoryApi, directorySettings } from './directory-routes.js';
...
export async function handleApi(req, res, ctx) {
  ...
  // Directory submission (Pro "submit anywhere") — bridge/directory-routes.js.
  if (await handleDirectoryApi(req, res, { json, readBody })) return true;
